...
def decision_tree_classification(X_train, X_test, y_train, y_test, max_depth = None, min_samples_leaf = None):
    # create model
...
if __name__ == '__main__':
    ...
    max_depth = None
    min_samples_leaf = 1
    decision_tree_classification(X_train, X_test, y_train, y_test, max_depth, min_samples_leaf)

    # tune decision tree
    best_max_depth, best_min_samples_leaf = decision_tree_tune(X_train, X_test, y_train, y_test)

    # tune result
    decision_tree_classification(X_train, X_test, y_train, y_test, best_max_depth, best_min_samples_leaf)
